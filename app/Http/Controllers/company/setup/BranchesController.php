...
class BranchesController extends RootController
{
    public $permissions;
    public function __construct(Request $request)
    {
        ...
        $this->permissions=CompanyTaskHelper::getPermissions($companyId,'setup/branches',$this->user->companyUserGroupRole);        
    }
    ...
    public function getItems($companyId,Request $request)
    {
        if ($this->permissions['action_0'] == 1){
            ...
            $query->orderBy('branches.id', 'DESC');
