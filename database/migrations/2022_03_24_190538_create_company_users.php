...
class CreateCompanyUsers extends Migration
{
    ...
    public function up()
    {
        Schema::create(TABLE_COMPANY_USERS, function (Blueprint $table) {
            ...
            $table->enum('reason_status_active', [COMPANY_USER_STATUS_ACTIVE_ADMIN_ADD, COMPANY_USER_STATUS_ACTIVE_ADMIN_INVITATION, COMPANY_USER_STATUS_ACTIVE_OWNER_INVITATION, COMPANY_USER_STATUS_ACTIVE_USER_REQUEST])->nullable();;
            $table->integer('status_active_id')->default(0);
            $table->enum('reason_status_inactive', [COMPANY_USER_STATUS_INACTIVE_ADMIN_REMOVE, COMPANY_USER_STATUS_INACTIVE_OWNER_REMOVE, COMPANY_USER_STATUS_INACTIVE_USER_LEAVE])->nullable();
