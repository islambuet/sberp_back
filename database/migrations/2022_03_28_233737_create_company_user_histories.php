...
class CreateCompanyUserHistories extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(TABLE_COMPANY_USER_HISTORIES, function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists(TABLE_COMPANY_USER_HISTORIES);
    }
}
